    ...
    if (isset($_GET['submit']))
{
    ...
    $query="UPDATE users set firstname='$firstname'WHERE id='$id5'";
	...
	<form method="POST">
        ...
        <div class="form-group">
            ...
            <label for="firstnameinput" class="text-white">Id</label>
            <input type="text" class="form-control" id="firstnameinput" placeholder="Enter firstname" name="id5" value="<?php echo $data['id']; ?>">
            <span>
            <span>
            <?php
                if(isset($_GET["error"])){
